...
$route->get("/desativar_conta", [usuarioController::class, "desativarConta"]);
$route->get("/reativar_conta", [usuarioController::class, "reativarConta"]);
$route->get("/desativar_workspace", [workspaceController::class, "alterarAtivoWorkspace"]);
$route->get("/workspaces_desativados", [workspaceController::class, "mostrarWorkspacesDesativados"]); // Nova rota
...
$route->get("/remover_usuario_workspace", [workspaceController::class, "removerUsuarioDoWorkspace"]);
...
$route->post("/editar_perfil", [usuarioController::class, "alterarDadosUsuario"]);
$route->post("/reativar_conta", [usuarioController::class, "reativarConta"]);
