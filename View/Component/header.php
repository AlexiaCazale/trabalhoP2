...
<nav class="navbar navbar-expand-lg" style="background-color: #9A8ACF; border-bottom: unset;">
	<div class="container-fluid">
	  ...
	  <ul class="navbar-nav navbar-nav-pills" style="display: flex; align-items: center;">
		<a class="navbar-brand" href="/trabalhoP2"><img src="View/Images/logo.png" width="40" /></a>
		<h4 style="margin: 0;">
		  TaskHub
		</h4>
	  </ul>
