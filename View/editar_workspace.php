...
<form method="post" action="/trabalhoP2/editar_workspace">
  ...
  <input type="hidden" name="id_workspace" value="<?= htmlspecialchars($workspace->getId()) ?>">
  ...
  <div style="display: flex; flex-direction:column; align-items:center">
    ...
    <div class="col-md-4 position-relative">
      ...
      <input type="text" name="nome" class="form-control" id="validationTooltip01" 
        ...
        value="<?= htmlspecialchars($workspace->getNome()) ?>">
    ...
    <div class="col-md-4">
      ...
      <textarea name="descricao" class="form-control" id="validationTextarea" 
        placeholder="Escreva uma descrição para sua atividade" required><?= htmlspecialchars($workspace->getDescricao()) ?></textarea>
      <div class="invalid-feedback">
        Campo obrigatório!
      </div>
    </div>
